...
OBJECTS       = harbour-bmi_calculator.o
DIST          = /usr/share/qt5/mkspecs/features/spec_pre.prf \
		...
		harbour-bmi_calculator.pro \
		harbour-bmi_calculator.pro
QMAKE_TARGET  = harbour-bmi_calculator
...
Makefile: harbour-bmi_calculator.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/harbour-bmi_calculator1.0.0 || mkdir -p .tmp/harbour-bmi_calculator1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/harbour-bmi_calculator1.0.0/ && $(COPY_FILE) --parents src/harbour-bmi_calculator.cpp .tmp/harbour-bmi_calculator1.0.0/ && (cd `dirname .tmp/harbour-bmi_calculator1.0.0` && $(TAR) harbour-bmi_calculator1.0.0.tar harbour-bmi_calculator1.0.0 && $(COMPRESS) harbour-bmi_calculator1.0.0.tar) && $(MOVE) `dirname .tmp/harbour-bmi_calculator1.0.0`/harbour-bmi_calculator1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/harbour-bmi_calculator1.0.0
...
harbour-bmi_calculator.o: src/harbour-bmi_calculator.cpp /usr/include/qt5/QtQuick/QtQuick \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o harbour-bmi_calculator.o src/harbour-bmi_calculator.cpp
...
install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-bmi_calculator || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-bmi_calculator
	-$(INSTALL_DIR) /home/mersdk/QtProjects/harbour-bmi_calculator/qml $(INSTALL_ROOT)/usr/share/harbour-bmi_calculator/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-bmi_calculator/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-bmi_calculator/ 


install_desktop: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || mkdir -p $(INSTALL_ROOT)/usr/share/applications
	-$(INSTALL_PROGRAM) /home/mersdk/QtProjects/harbour-bmi_calculator/harbour-bmi_calculator.desktop $(INSTALL_ROOT)/usr/share/applications/
	-: $(INSTALL_ROOT)/usr/share/applications/harbour-bmi_calculator.desktop

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/harbour-bmi_calculator.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/QtProjects/harbour-bmi_calculator/harbour-bmi_calculator.png $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/
	-: $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-bmi_calculator.png

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-bmi_calculator.png
